...
<p style="margin-bottom: 15px;">This e-mail was sent from Agaram Technologies (https://www.agaramtech.com). </p>
        ...
        if($mail->Send()) {
        // Prepare an insert statement
        $sql = "INSERT INTO `tblfree`(`cOrganisation`, `cName`, `cEmail`, `cPhone`, `cAddress`, `cCountry`, `noofusers`)  VALUES (?, ?, ?, ?, ?, ?, ?)";
		
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
			
            mysqli_stmt_bind_param($stmt, "sssssss", $oname, $cname, $cemail, $cphone, $caddress, $country, $noofusers);
...
<html lang="en">
   <head>
      ...
      <title>Free Plan Enquiry - Agaramtech</title>
      <!-- Bootstrap CSS -->
               ...
               <div class="row">
                  <div class="col-lg-8">
                     <form action="#" class="contact_form_box" method="post" id="">
                        <h2 class="f_p f_size_22 t_color3 f_600 l_height28 mt_20 mb_40">Free Plan Registration</h2>
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                              <div class="form-group text_box">
                                 <input type="number" id=""  name="noofusers" placeholder="No. of Users (max 3) *" min="1" max="3" required>
                              </div>
                           </div>
                           <div class="col-lg-12">
                              <div class="form-group text_box">
