...
<p style="margin-bottom: 15px;">This e-mail was sent from Agaram Technologies (https://www.agaramtech.com). </p>
        ...
        if($mail->Send()) {
        // Prepare an insert statement
        $sql = "INSERT INTO `tblpremium`(`cOrganisation`, `cName`, `cEmail`, `cPhone`, `cAddress`, `cCountry`, `noofusers`, `currency`)  VALUES (?, ?, ?, ?, ?, ?, ? ,?)";
...
<html lang="en">
   <head>
      ...
      <title>Premium Plan Enquiry - Agaramtech</title>
      <!-- Bootstrap CSS -->
               ...
               <div class="row">
                  <div class="col-lg-8">
                     <form action="#" class="contact_form_box" method="post" id="">
                        <h2 class="f_p f_size_22 t_color3 f_600 l_height28 mt_20 mb_40">Premium Plan Registration</h2>
                        <div class="row">
