...
$noofsites = trim($_POST["noofsites"]);
$storage = trim($_POST["storage"]);
$dataresidency = trim($_POST["dataresidency"]);
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#f5f6fa">
            <tr>
             ...
             <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">No of Users: '.$noofusers.'</p>
               ...
               <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">No of Sites: '.$noofsites.'</p>
               <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Storage: '.$storage.'</p>
               <p style="margin-bottom: 15px; color: #526484; font-size: 16px;">Data Residency: '.$dataresidency.'</p>
...
<p style="margin-bottom: 15px;">This e-mail was sent from Agaram Technologies (https://www.agaramtech.com). </p>
        ...
        if($mail->Send()) {
        // Prepare an insert statement
        $sql = "INSERT INTO `tblenterprise`(`cOrganisation`, `cName`, `cEmail`, `cPhone`, `cAddress`, `cCountry`, `currency`, `noofusers`, `noofsites`, `storage`, `dataresidency`) VALUES (?, ?, ?, ?, ?, ?, ? ,? ,? ,? ,?)";
		
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
			
            mysqli_stmt_bind_param($stmt, "sssssssssss", $oname, $cname, $cemail, $cphone, $caddress, $country, $currency,$noofusers, $noofsites, $storage, $dataresidency);
...
<html lang="en">
   <head>
      ...
      <title>Enterprise Plan Enquiry - Agaramtech</title>
      <!-- Bootstrap CSS -->
               ...
               <div class="row">
                  <div class="col-lg-8">
                     <form action="#" class="contact_form_box" method="post" id="">
                        <h2 class="f_p f_size_22 t_color3 f_600 l_height28 mt_20 mb_40">Enterprise Plan Registration</h2>
                        <div class="row">
                           ...
                           <div class="col-lg-6">
                              <div class="form-group text_box">
                                 <input type="number" id=""  name="noofusers" placeholder="No. of Users *"   required>	
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="form-group text_box">
                                 <input type="number" id=""  name="noofsites" placeholder="No. of sites"  max="1000">	
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="form-group text_box">
                                 <input type="text" id="" name="storage" placeholder="Storage Required " >
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="form-group text_box">
                                 <input type="text" id="" name="dataresidency" placeholder="Data Residency*" required>
                              </div>
                           </div>
                           <div class="col-lg-12">
                              <div class="form-group text_box">
